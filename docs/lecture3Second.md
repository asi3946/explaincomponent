...
-->
---
component/DetailCard.module.css
```css
.container {
...
```
<!--
モックデータというのはテストのためにファイルの中に置いておくデータのことです。みなさんがつくるものではデータをDBで管理すると思うのでこういうもので確認するんだなと思ってくれれば大丈夫です。今まで使っていたものに加えて、imageURLを追加しています。
-->
---
